...
class ContentModel(Base):
    ...
    selected_variant_asset_id: Mapped[Optional[str]] = mapped_column(String(64), nullable=True)
    overlay_headline: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    overlay_subheadline: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    overlay_cta: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
